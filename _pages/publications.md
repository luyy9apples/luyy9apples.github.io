...
<br>`Knowledge Graph` `Complex Query Answering` `Logical Reasoning`

[**An Efficient Fuzzy System for Complex Query Answering on Knowledge Graphs**](https://ieeexplore.ieee.org/document/11053687)
<br>**Yuyin Lu**, Hegang Chen, Yanghui Rao, Jianxing Yu, Wen Hua, Qing Li
<br>*IEEE Transactions on Knowledge and Data Engineering* (**IEEE TKDE**), 2025.
<br>`Knowledge Graph` `Complex Query Answering` `Fuzzy Logic`

[**Leveraging Open Path from Pruned Graph for Link Prediction on Knowledge Graphs**](https://link.springer.com/content/pdf/10.1007/978-3-032-09527-5_30.pdf)
<br>Xingyu Liu, **Yuyin Lu**, Yanghui Rao
<br>*International Semantic Web Conference*  (**ISWC**), 2025.
<br>`Knowledge Graph` `Link Prediction` `Graph Probing`
...
<br>*Transactions of the Association for Computational Linguistics* (**TACL**), 2024 · Presented at **EMNLP 2024**
<br>`NLP` `Representation Learning`  `Topic Modeling`

[**Graph-based Dynamic Word Embeddings**](https://www.ijcai.org/proceedings/2022/0594.pdf)
<br>**Yuyin Lu**, Xin Cheng,  Ziran Liang, Yanghui Rao
